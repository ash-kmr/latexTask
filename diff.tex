...
%DIF DEL old.tex   Mon Feb 19 17:12:20 2018
%DIF ADD new.tex   Mon Feb 19 17:12:20 2018
...
\begin{document}
\DIFaddbegin \hyphenation{op-tical net-works semi-conduc-tor}
\DIFaddend %
% --- Author Metadata here ---
\DIFdelbegin %DIFDELCMD < \conferenceinfo{WOODSTOCK}{'97 El Paso, Texas USA}
%DIFDELCMD < %%%
\DIFdelend %DIF > \conferenceinfo{WOODSTOCK}{'97 El Paso, Texas USA}
...
\DIFdelend %  in this sample file, there are a *total*
% of EIGHT authors. SIX appear on the 'first-page' (for formatting
% reasons) and the remaining two appear in the \additionalauthors section.
%
\DIFdelbegin %DIFDELCMD < \author{
%DIFDELCMD < %%%
\DIFdelend % You can go ahead and credit any number of authors here,
...
%
% 1st. author
\DIFdelbegin %DIFDELCMD < \alignauthor
%DIFDELCMD < %%%
\DIFdel{Mukesh Saini}%DIFDELCMD < \\
%DIFDELCMD <        {\mytext{Dept. of Computer Science}}\\
%DIFDELCMD <        {\mytext{National University of Singapore}}\\
%DIFDELCMD <        \email{mksaini@comp.nus.edu.sg}
%DIFDELCMD < %%%
%DIF <  2nd. author
%DIFDELCMD < \alignauthor
%DIFDELCMD < %%%
\DIFdel{Raghudeep Gadde}%DIFDELCMD < \\
%DIFDELCMD <        {\mytext{Dept. of ECE}}\\
%DIFDELCMD <        {\mytext{National University of Singapore}}\\
%DIFDELCMD <        \email{elerdg@comp.nus.edu.sg}
%DIFDELCMD < %%%
%DIF <  3rd. author
\DIFdelend \DIFaddbegin \author{\IEEEauthorblockN{Ashish Kumar}
\IEEEauthorblockA{Dept. of Computer Science\\
IIT Ropar\\
Email: 2016csb1033@iitrpr.ac.in}
\DIFaddend \and
\DIFdelbegin %DIFDELCMD < \alignauthor %%%
\DIFdel{Shuicheng Yan}%DIFDELCMD < \\
%DIFDELCMD <        \mytext{Dept. of ECE}\\
%DIFDELCMD <        \mytext{National University of Singapore}\\
%DIFDELCMD <        \email{eleryan@nus.edu.sg}
%DIFDELCMD <  %%%
%DIF <  use '\and' if you need 'another row' of author names
%DIF <  4th. author
%DIFDELCMD < \alignauthor %%%
\DIFdel{Wei Tsang Ooi}%DIFDELCMD < \\
%DIFDELCMD <        \mytext{Dept. of Computer Science}\\
%DIFDELCMD <        \mytext{National University of Singapore}\\
%DIFDELCMD <        \email{ooiwt@comp.nus.edu.sg}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \IEEEauthorblockN{Siddharth Nahar}
\IEEEauthorblockA{Dept. of Computer Science\\
IIT Ropar
Email: 2016csb1043@iitrpr.ac.in}
\and
\IEEEauthorblockN{Rahul Lahane}
\IEEEauthorblockA{Dept. of Computer Science\\
IIT Ropar\\
Email: 2016csb10xx@iitrpr.ac.in}
\and
\IEEEauthorblockN{Anurag Singh Mehta}
\IEEEauthorblockA{Dept. of Computer Science\\
IIT Ropar
Email: 2016csb1111@iitrpr.ac.in}\DIFaddend }
...
share them with friends and public. As \DIFdelbegin \DIFdel{an attendee of such live performances typically }\DIFdelend \DIFaddbegin \DIFadd{someone who is attending such live performance }\DIFaddend has limited mobility, \DIFdelbegin \DIFdel{each video camera is
}\DIFdelend \DIFaddbegin \DIFadd{video cameras are restricted to being }\DIFaddend able to capture only \DIFdelbegin \DIFdel{from a range of restricted viewing angles and
distance, producing a rather monotonous video }\DIFdelend \DIFaddbegin \DIFadd{a few limited angles which produces a monotonous }\DIFaddend clip. At such per-
...
rently available videos. \DIFdelbegin \DIFdel{In real video editing process, however, re-
...
cover the performance from diverse perspectives. }\DIFdelend Shot transition
...
\DIFdelbegin %DIFDELCMD < \\\\
%DIFDELCMD < %%%
\DIFdelend \textbf{Categories and Subject Descriptors}
...
\DIFdelbegin \DIFdel{Worldwide shipment of camera phones were estimated to reach
}\DIFdelend \DIFaddbegin \DIFadd{The estimate was that camera phone supply would increase to }\DIFaddend 1.14 billion \DIFdelbegin \DIFdel{in the year 2011 alone }\DIFdelend \DIFaddbegin \DIFadd{by the end of 2011.}\DIFaddend \cite{1}. Furthermore, a survey of
...
\DIFaddbegin 
 ...
 \DIFaddend \item \textbf{Burned Pixels: }It has been identified that pixels that are
...
\DIFdelend \DIFaddbegin \\
    \DIFaddend \item For the given content, the user interest decreases with time
...
\DIFaddbegin \begin{figure*}
    ...
    \label{fig:my_label}
\end{figure*}
\DIFaddend where v is the difference of the scores, i.e., v = ${S^{f}_1}$ - ${S^{f}_2}$ and $\zeta$ is
...
%DIFDELCMD <     \centering
%DIFDELCMD <     \includegraphics{img6.png}
%DIFDELCMD <     %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Caption}}
    %DIFAUXCMD
%DIFDELCMD < \label{fig:my_label}
%DIFDELCMD < \end{figure*}
%DIFDELCMD < %%%
\DIFdelend In general cases, camera switching only takes place after the se-
...
video quality ratings, \DIFaddbegin \DIFadd{they liked following things about MoViMash:
complete coverage (from many angles), smooth shot transitions,
less occlusion, and balanced }\DIFaddend camera selection. Yet, there might
